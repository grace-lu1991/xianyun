    	...
    	<div class="banner-content">
			<div class="search-bar">
				...
				<el-row type="flex" class="search-tab">
					<span v-for="(tabItem,index) in options" :key="index"
...
export default {
 data(){
   return{
banners:[{url:'http://157.122.54.189:9095/assets/images/th01.jfif'},
{url:'http://157.122.54.189:9095/assets/images/th02.jfif'}],
options:[{text:'攻略',placeholder:'搜索城市'},
{text:'酒店',placeholder:'请输入城市搜索酒店'},
{text:'机票',placeholder:''}
],
current:0,
   }
